...
namespace easy
{
	...
	public class JSON
	{
		...
		protected static object ParseNumber(char[] json, ref int index)
		{
			...
			return ParseNumeric(new string(numberCharArray));
		}
		protected static object ParseNumeric(string data)
		{
			if(JSON.IsInt(data) == true)
				return int.Parse(data);
			else if(JSON.IsLong(data) == true)
				return long.Parse(data);
			else if(JSON.IsFloat(data) == true)
				return float.Parse(data);

			//else if(JSON.IsDouble(s) == true)
		...
		protected static bool SerializeValue(object value, StringBuilder builder)
		{
			...
			if (value is string) {
				...
				success = SerializeNumber(double.Parse(value.ToString()), builder);
		...
		{
			int result;
			return (o == null) ? false : int.TryParse(o.ToString(), out result);
		}
		public static bool IsLong(object o)
		{
			long result;
			return (o == null) ? false : long.TryParse(o.ToString(), out result);
		}
		...
		{
			if(string.IsNullOrEmpty(o) == true)
				return false;
			string result = o.ToLower();
			if(result.Equals("true") == true || result.Equals("false") == true)
				return true;
			return false;
		}
	}
